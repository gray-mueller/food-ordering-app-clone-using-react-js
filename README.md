<h2 style="text-align:center">Food Ordering App Clone Using React Js </h2>
  ...
  The food ordering app clone using react js frontend source code for our solution is completely open source. However, the API and backend is proprietary and can be accessed via a paid license. For more details, <a href="https://onboarding.enatega.com/register/?utm_source=github&utm_medium=repo&utm_campaign=gray-food-ordering-app-clone-using-react-js" target="_blank">click here</a>.